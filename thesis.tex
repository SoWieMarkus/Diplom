...
\begin{document}
  ...
  \supervisor{%
    Dipl. Inf. Philipp Matthes
  }
  \professor{ TODO Prof. Dr. rer. nat. habil. Max Mustermann}
  ...
  \input{sections/2-problemanalyse.tex}
  \input{sections/3-zielstellung.tex}
  \input{sections/4-related.tex}
  \input{sections/5-lösungsansatz.tex}
  \input{sections/6-evaluation.tex}
  \input{sections/7-zeitplan.tex}
